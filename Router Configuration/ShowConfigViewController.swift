...
class ShowConfigViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        navigationItem.title = "Select a Router"
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = routers[indexPath.row].text

        return cell
    }
    
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("selected \(routers[indexPath.row].text)")
        selectedRouter = routers[indexPath.row].text
        performSegue(withIdentifier: "showConfigToLogin", sender: nil)
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "showConfigToLogin") {
